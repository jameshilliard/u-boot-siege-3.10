...
int usb_stor_scan(int mode)
{
	...
	for (i = 0; i < USB_MAX_DEVICE; i++) {
		...
		if (usb_storage_probe(dev, 0, &usb_stor[usb_max_devs])) {
			...
			/* Some devices are broken and report an invalid max
			 * LUN.
			 */
			switch ((dev->descriptor.idVendor << 16 )
				| dev->descriptor.idProduct) {
			case 0x04090040:	/* NEC */
			case 0x04360005:	/* Microtech CameraMate */
			case 0x04a40004:	/* Hitachi DVD-CAM */
			case 0x04b80602:	/* Epson 785EPX Storage */
			case 0x04cb0100:	/* Fujifilm FinePix 1400Zoom */
			case 0x04e60005:	/* SCM eUSB CompactFlash adap */
			case 0x04e60006:	/* SCM eUSB MMC Adapter */
			case 0x04e60007:	/* Sony Hifd */
			case 0x054c0010:	/* Sony */
			case 0x054c0025:	/* Sony */
			case 0x054c002c:	/* Sony */
			case 0x054c002d:	/* Sony */
			case 0x054c002e:	/* Sony */
			case 0x054c0032:	/* Sony */
			case 0x054c0069:	/* Sony */
			case 0x055d2020:	/* Samsung SDF-321U [FW 0C] */
			case 0x057b0000:	/* Flashbuster-U */
			case 0x059b0001:	/* Iomega ZIP 100 */
			case 0x07810001:	/* SanDisk */
			case 0x07810002:
			case 0x07810100:
			case 0x07811234:	/* Cruzer */
			case 0x07815150:	/* Cruzer */
			case 0x07815151:	/* Cruzer */
			case 0x07815153:	/* Cruzer */
			case 0x07815402:	/* Cruzer */
			case 0x07815406:	/* Cruzer */
			case 0x07815408:	/* Cruzer */
			case 0x0781540e:	/* Cruzer */
			case 0x07815530:	/* Cruzer */
			case 0x07815567:	/* Cruzer */
			case 0x07816100:	/* Cruzer */
			case 0x07817100:	/* Cruzer */
			case 0x07817101:	/* Cruzer */
			case 0x07817102:	/* Cruzer */
			case 0x07817103:	/* Cruzer */
			case 0x07817104:	/* Cruzer */
			case 0x07817105:	/* Cruzer */
			case 0x07817106:	/* Cruzer */
			case 0x07817112:	/* Cruzer */
			case 0x07817113:	/* Cruzer */
			case 0x07817114:	/* Cruzer */
			case 0x07817115:	/* Cruzer */
			case 0x07af0006:	/* Microtech CameraMate */
			case 0x08bd1100:	/* Citizen X1DE-USB */
			case 0x0c451060:	/* Unknown */
				if (max_lun != 0)
					printf("USB device reports invalid "
					       "max LUN %d, changing to 0\n",
					       max_lun);
				max_lun = 0;
				break;
			default:
...
static int usb_stor_BBB_comdat(ccb *srb, struct us_data *us)
{
	...
	/* If its a extended command, direction is decided by second byte */
#ifdef CONFIG_SRX_SIEGE
	if (srb->priv == SCSI_EXTENSION)
		dir_in = US_DIRECTION(srb->cmd[1]);
#endif
...
static int usb_read_16(ccb *srb, struct us_data *ss, unsigned long long start,
		       unsigned int blocks)
{
	memset(&srb->cmd[0], 0, 18);
	...
	srb->cmd[10] = ((unsigned char) (blocks >> 24)) & 0xff;
	srb->cmd[11] = ((unsigned char) (blocks >> 16)) & 0xff;
...
#else
	debug("read16: start %lx blocks %x\n", start, blocks);
#endif
	return ss->transport(srb, ss);
}

static int usb_write_16(ccb *srb, struct us_data *ss, unsigned long long start,
			unsigned int blocks)
{
	memset(&srb->cmd[0], 0, 18);
	...
	srb->cmdlen = 18;
#ifdef CONFIG_SRX_SIEGE
	debug("write10: start %llx blocks %x\n", start, blocks);
#else
	debug("write10: start %lx blocks %x\n", start, blocks);
#endif
	return ss->transport(srb, ss);
...
#ifdef CONFIG_SYS_64BIT_LBA
		if (start + smallblks > 0xffffffff) {
			if (usb_write_16(srb, ss, start, smallblks)) {
				debug("Write16 ERROR\n");
				usb_request_sense(srb, ss);
				if (retry--)
					goto retry_it;
...
extern int octeon_xhci_csr_timeout;
int
usb_disk_scan(int dev)
{
	...
	if (!usb_started) {
        int max_retries = getenv_ulong("USB_MAX_RETRIES", 0, 10);

        for (i = 0; i < max_retries; i++) {
            octeon_xhci_csr_timeout = 0;
            ...
            if (octeon_xhci_csr_timeout) {
                printf("Retrying USB init..\n");
                usb_stop();
            } else {
                break;
            }
    ...
    /* for usb_disk_read */
	bounce_buffer = (void *)JSRX_SIEGE_USB_BOUNCE_BUFFER_OFFSET;

	count = (dev < 0) ? 0 : dev + 1;
	dev = (dev < 0) ? usb_max_devs - 1 : dev + 1;
	while (count <= dev) {
		if (usb_dev_desc[count].target != 0xff) {
			return (count);
        }
		count++;
	}
...
/* Juniper, codes port from u-boot 1.1.6 */
int
usb_disk_read(int dev, int lba, int totcnt, char *buf)
{
	unsigned long rd;
	unsigned long mediasz;
	char *iobuf;
	int cnt;

	if (dev < 0 || dev >= usb_max_devs)
		return (-1);

	mediasz = usb_stor_get_dev(dev)->lba;

	while (totcnt > 0) {
		reload_watchdog(PAT_WATCHDOG);
		if (lba >= mediasz)
			break;
		cnt = (totcnt <= USB_MAX_READ_BLK) ? totcnt : USB_MAX_READ_BLK;
		if (cnt > mediasz - lba)
			cnt = mediasz - lba;
		iobuf = (bounce_buffer != NULL) ? bounce_buffer : buf;
		rd = usb_stor_read(dev, (lbaint_t)lba, (lbaint_t)cnt, (unsigned long *)iobuf);
		if (rd == 0)
			return (totcnt);
		if (iobuf != buf)
			memcpy(buf, iobuf, cnt * 512);
		buf += cnt * 512;
		lba += cnt;
		totcnt -= cnt;
	}
...
int
usb_disk_write(int dev, int lba, int cnt, void *buf)
{
	return (-1);
}

#else  /* not CONFIG_SRX_SIEGE*/
#define NEED_USB_DISK_API_STUBS
#endif

#ifdef NEED_USB_DISK_API_STUBS
int
usb_disk_scan(int dev)
{
	return (-1);
