 ...
 * GPL sources:
 * based on http://git.denx.de/?p=u-boot.git;a=blob;f=drivers/mtd/spi/sf_probe.c;h=7b296378d2be4fa20a274219a63ae93fee95eae4;hb=793fd86f722f5c5e13290be2074816b001359b76
 */
...
static const struct spi_flash_params spi_flash_params_table[] = {
	...
	{"MT25QL064",	   0x20ba17, 0x0,	64 * 1024,   128,		SECT_4K},
	{"MT25QU064",	   0x20bb17, 0x0,	64 * 1024,   128,		SECT_4K},
	{"MT25QL128",	   0x20ba18, 0x0,	64 * 1024,   256,		SECT_4K},
	{"MT25QU128",	   0x20bb18, 0x0,	64 * 1024,   256,		SECT_4K},
	{"MT25QL256",	   0x20ba19, 0x0,	64 * 1024,   512,		SECT_4K},
	{"MT25QU256",	   0x20bb19, 0x0,	64 * 1024,   512,		SECT_4K},
	{"MT25QL512",	   0x20ba20, 0x0,	64 * 1024,  1024,		SECT_4K},
	{"MT25QU512",	   0x20bb20, 0x0,	64 * 1024,  1024,		SECT_4K},
	{"MT25QL01G",	   0x20ba21, 0x0,	64 * 1024,  2048,		SECT_4K},
	{"MT25QU01G",	   0x20bb21, 0x0,	64 * 1024,  2048,		SECT_4K},
	{"MT25QL02G",	   0x20ba22, 0x0,	64 * 1024,  4096,		SECT_4K},
	{"MT25QU02G",	   0x20bb22, 0x0,	64 * 1024,  4096,		SECT_4K},
#endif
	...
	{"W25Q64JVQ",	   0xef4017, 0x0,	64 * 1024,   128,	      SECT_4K},
	...
	{"W25Q64JVM",	   0xef7017, 0x0,	64 * 1024,   128,	      SECT_4K},
#endif
	/*
	 * Note:
...
extern void disable_srx_siege_watchdog(void);
extern void cpld_set_bootfinish(void);
#endif
		...
		u8 *idcode)
{
...
#ifdef CONFIG_SRX_SIEGE_STAGE3 
		printf("ERROR: Unexpected flash, hardware problem !!!\n");
	...
	if (flash->size > 0x1000000) {
		flash->addr_width = 4;
		spi_flash_set_4byte(flash, idcode[0], true);
	} else {
		flash->addr_width = 3;
	}
		...
		unsigned int max_hz, unsigned int spi_mode)
{
	...
	printf("SF: Detected SF with page size ");
#else
