...
extern int uart_debug(const char *fmt, ...);
...
void	board_init_r  (gd_t *, ulong) __attribute__ ((noreturn));
#else
void	board_init_r  (gd_t *, u64) __attribute__ ((noreturn));
#endif
#endif
int	checkboard    (void);
int	checkflash    (void);
 ...
 */
	...
	!defined(CONFIG_SYS_DEF_EEPROM_ADDR)
