...
void _70xx_perform_octeon3_ddr3_sequence(uint32_t cpu_id, int node, int rank_mask,
...
void _70xx_ddr4_mpr_read(uint32_t cpu_id, int node, int ddr_interface_num, int rank,
		   int page, int location, uint64_t *mpr_data)
{
    ...
    _70xx_perform_octeon3_ddr3_sequence(cpu_id, node, 1 << rank, ddr_interface_num, 0x9);
...
void _70xx_set_vref(uint32_t cpu_id, int node, int ddr_interface_num, int rank,
	      int range, int value)
{
    cvmx_lmcx_mr_mpr_ctl_t lmc_mr_mpr_ctl;
    ...
    _70xx_perform_octeon3_ddr3_sequence(cpu_id, node, 1<<rank, ddr_interface_num, 0x8);
...
static unsigned char _70xx_ddr4_rodt_ohms     [RODT_OHMS_COUNT     ] = {  0,  40,  60, 80, 120, 240, 34, 48 };
static unsigned char _70xx_ddr4_rtt_nom_ohms  [RTT_NOM_OHMS_COUNT  ] = {  0,  60, 120, 40, 240,  48, 80, 34 };
static unsigned char _70xx_ddr4_rtt_nom_table [RTT_NOM_TABLE_COUNT ] = {  0,   4,   2,  6,   1,   5,  3,  7 };
static unsigned char _70xx_ddr4_rtt_wr_ohms   [RTT_WR_OHMS_COUNT   ] = {  0, 120,  40 };
static unsigned char _70xx_ddr4_dic_ohms      [DIC_OHMS_COUNT      ] = { 34,  48 };
static short         _70xx_ddr4_drive_strength[DRIVE_STRENGTH_COUNT] = {  0,   0,  26, 30,  34,  40, 48, 68, 0,0,0,0,0,0,0 };
static _70xx_impedence_values_t _70xx_ddr4_impedence_values = {
    .rodt_ohms             =  _70xx_ddr4_rodt_ohms     ,
    .rtt_nom_ohms          =  _70xx_ddr4_rtt_nom_ohms  ,
    .rtt_nom_table         =  _70xx_ddr4_rtt_nom_table ,
    .rtt_wr_ohms           =  _70xx_ddr4_rtt_wr_ohms   ,
    .dic_ohms              =  _70xx_ddr4_dic_ohms      ,
    .drive_strength        =  _70xx_ddr4_drive_strength,
};

static unsigned char _70xx_ddr3_rodt_ohms     [RODT_OHMS_COUNT     ] = { 0, 20, 30, 40, 60, 120, 0, 0 };
static unsigned char _70xx_ddr3_rtt_nom_ohms  [RTT_NOM_OHMS_COUNT  ] = { 0, 60, 120, 40, 20, 30, 0, 0 };
static unsigned char _70xx_ddr3_rtt_nom_table [RTT_NOM_TABLE_COUNT ] = { 0, 2, 1, 3, 5, 4, 0, 0 };
static unsigned char _70xx_ddr3_rtt_wr_ohms   [RTT_WR_OHMS_COUNT   ] = { 0, 60, 120 };
static unsigned char _70xx_ddr3_dic_ohms      [DIC_OHMS_COUNT      ] = { 40, 34 };
static short         _70xx_ddr3_drive_strength[DRIVE_STRENGTH_COUNT] = { 0, 24, 27, 30, 34, 40, 48, 60, 0,0,0,0,0,0,0 };
static _70xx_impedence_values_t _70xx_ddr3_impedence_values = {
    .rodt_ohms             =  _70xx_ddr3_rodt_ohms     ,
    .rtt_nom_ohms          =  _70xx_ddr3_rtt_nom_ohms  ,
    .rtt_nom_table         =  _70xx_ddr3_rtt_nom_table ,
    .rtt_wr_ohms           =  _70xx_ddr3_rtt_wr_ohms   ,
    .dic_ohms              =  _70xx_ddr3_dic_ohms      ,
    .drive_strength        =  _70xx_ddr3_drive_strength,
};
...
int
#endif
_70xx_init_octeon3_ddr3_interface(uint32_t cpu_id,
...
#pragma pack(push,1)
    ...
    */
    ...
    _70xx_impedence_values_t *imp_values;
#pragma pack(pop)

#if 1
    PRINT_CURSP("_70xx_init_octeon3_ddr3_interface");
#endif
    ...
    if (ddr_type == DDR4_DRAM) {
        imp_values = &_70xx_ddr4_impedence_values;
        ...
        imp_values = &_70xx_ddr3_impedence_values;
...
#define _70XX_DIVIDEND_SCALE 100      /* Scale by 100 to avoid rounding error. */
#define _70XX_ENCODING_BASE 1260

                lmc_dimmx_ddr4_params0.s.rc3x = divide_nint((((2 * 1000000 * _70XX_DIVIDEND_SCALE) /
                                                              (tclk_psecs * _70XX_DIVIDEND_SCALE)) - _70XX_ENCODING_BASE), 20);
    ...
    /*
     * Comments (steps 3 through 5) continue in _70xx_perform_octeon3_ddr3_sequence()
     */
    ...
    _70xx_perform_octeon3_ddr3_sequence(cpu_id, node, rank_mask, ddr_interface_num, 0x0A); /* LMC Internal Vref Training */
    ...
    _70xx_perform_octeon3_ddr3_sequence(cpu_id, node, rank_mask, ddr_interface_num, 0x0A); /* LMC Deskew Training */
     ...
     */
    {
        ...
        for (rankx = 0; rankx < dimm_count * 4;rankx++) {
            ...
            for (passx=0; passx<(8+ecc_ena); ++passx) {
                ...
                _70xx_perform_octeon3_ddr3_sequence(cpu_id, node, 1 << rankx,
...
#if 0
            temp_delay_usecs = (((uint64_t)save_ref_zqcs_int >> 7)
                                * tclk_psecs * 512 * 128) / (100*10000)
                + 10 * ((uint64_t)32 * tclk_psecs * 512 * 128) / (100*10000);
#endif

            temp_delay_usecs = (((uint64_t)save_ref_zqcs_int >> 7) + 320);
            temp_delay_usecs = juniper_dmult(temp_delay_usecs, tclk_psecs);
            temp_delay_usecs = juniper_dmult(temp_delay_usecs, 512 * 128);
        ...
        ** ranks 0 and 2, but only 2 ranks are active. */
        ...
        for (rankx = 0; rankx < dimm_count * 4; rankx++) {
            ...
            for (vref_value=0; vref_value<(0x33+1); ++vref_value) {
                if (ddr_type == DDR4_DRAM) {
                    if (vref_value < 0x33) {
                        _70xx_set_vref(cpu_id, node, ddr_interface_num, rankx, 0, vref_value);
                    } else {
                        ...
                        _70xx_set_vref(cpu_id, node, ddr_interface_num, rankx, 0,
			         final_vref_value);
                    }
                } /* if (ddr_type == DDR4_DRAM) */
        ...
        for (rankx = 0; rankx < dimm_count * 4;rankx++) {
            ...
            _70xx_ddr4_mpr_read(cpu_id, node, ddr_interface_num, rankx,
			  /* page */ 2, /* location */ 0, &mpr_data[0]);
            ddr_print("MPR Page 2, Loc 0 %016llx.%016llx.%016llx\n", mpr_data[2], mpr_data[1], mpr_data[0]);

            _70xx_ddr4_mpr_read(cpu_id, node, ddr_interface_num, rankx, /* page */ 2,
